import { HTTP_NOT_FOUND, HTTP_SCHEMA_ERROR, HTTP_SERVER_ERROR, MSG_DUPLICATE_ERROR, MSG_FOREIGN_KEY_ERROR, MSG_NOT_FOUND, MSG_SERVER_ERROR } from "#utils/constants/api";
